# Purpose: KM sensitivity analyses, time on study as timescale
...
## subset datasets -----
names(dat)
dat_km <- list("dat_surv_insec2" = dat[["dat_surv_insec2"]],
               "dat_surv_insec2_5060" = dat[["dat_surv_insec2_5060"]],
               "dat_surv_insec2_over60" = dat[["dat_surv_insec2_over60"]],
               "dat_surv_sec2" = dat[["dat_surv_sec2"]],
               "dat_surv_sec2_5060" = dat[["dat_surv_sec2_5060"]],
               "dat_surv_sec2_over60" = dat[["dat_surv_sec2_over60"]],
               "dat_surv_cc" = dat[["dat_surv_cc"]],
               "dat_surv_cc_5060" = dat[["dat_surv_cc_5060"]],
               "dat_surv_cc_over60" = dat[["dat_surv_cc_over60"]])
...
test <- KM_results %>% filter(sample=="dat_surv_cc") %>% 
  arrange(age, weight)

# Save -----

saveRDS(KM_results, here("Aim_1", "data", "processed", "KM_results_sens.rds"))
